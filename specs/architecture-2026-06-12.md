...
- **Identity layer:** per-agent tokens issued through one-time-code enrollment; the server
  ...
  `specs/2026-06-12-agent-enrollment-design.md`.
...
|---|---|---|
| **M1 Security hardening** | 28 tasks: kill fallback tokens, default-deny, TLS, rate/body limits, non-root, agent kill-safety, mobile UX fixes | **Planned** — `specs/plans/2026-06-12-security-hardening.md`. Prerequisite for everything below. |
